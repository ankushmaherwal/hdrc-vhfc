 ...
 * @since  1.0.0
 */
class JFormFieldSenderParty extends JFormFieldList
{
	/**
	 * The form field type.
	 *
	...
	protected function getOptions()
	{
		...
		$senderPartyAccountCategory = $params->get('sender_party_category', 0);

		if ($senderPartyAccountCategory)
		{
			$query->where($db->quoteName('a.category_id') . '=' . $senderPartyAccountCategory);
		}
		...
		{
			$options[] = HTMLHelper::_('select.option', $account->id, $account->title);
		}
