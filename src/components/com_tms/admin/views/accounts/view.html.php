 ...
 * @since  1.0.0
 */
class TmsViewAccounts extends HtmlView
{
	/**
	...
	{
		JToolBarHelper::title(JText::_('COM_TMS_MANAGE_ACCOUNTS'), 'address tms');
	...
	protected function setDocument()
	{
		...
		$document->setTitle(JText::_('COM_TMS_MANAGE_ACCOUNTS'));
	}
}
