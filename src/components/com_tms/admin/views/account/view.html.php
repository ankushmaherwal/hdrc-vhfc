 ...
 * @since  1.0.0
 */
class TmsViewAccount extends HtmlView
{
	protected $form;
	...
	protected function addToolBar()
	{
		...
		JToolBarHelper::title($isNew ? JText::_('COM_TMS_ACCOUNT_CREATE') : JText::_('COM_TMS_ACCOUNT_EDIT'), 'apply');
	...
	protected function setDocument()
	{
		...
		$document->setTitle($isNew ? JText::_('COM_TMS_ACCOUNT_CREATE') : JText::_('COM_TMS_ACCOUNT_EDIT'));
	}
}
