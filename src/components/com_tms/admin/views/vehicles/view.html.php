 ...
 * @since  1.0.0
 */
class TmsViewVehicles extends HtmlView
{
	/**
	 * Display the vehicles list view
	 *
	...
	{
		JToolBarHelper::title(JText::_('COM_TMS_MANAGE_VEHICLES'), 'address tms');
	...
	protected function setDocument()
	{
		...
		$document->setTitle(JText::_('COM_TMS_MANAGE_VEHICLES'));
	}
}
